...
namespace TravelTracker.Web.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ArrangerAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArrangerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TravelerId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArrangerAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArrangerAssignments_AspNetUsers_ArrangerId",
                        column: x => x.ArrangerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArrangerAssignments_AspNetUsers_TravelerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectCode = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    CostCenter = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trips_AspNetUsers_TravelerId",
                        column: x => x.TravelerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LodgingName = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
                    ConfirmationNumber = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArrangerAssignments_ArrangerId_TravelerId",
                table: "ArrangerAssignments",
                columns: new[] { "ArrangerId", "TravelerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ArrangerAssignments_TravelerId",
                table: "ArrangerAssignments",
                column: "TravelerId");
